...
export const Recipes = () => {
  ...
  }, [recipes, searchTerm, categoryFilter, sortOrder]);

  if (isLoading) return <div className="p-xl text-center text-on-surface-variant font-body-md">Carregando fichas técnicas...</div>;
